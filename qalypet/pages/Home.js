...
function MyTabs() {
  return (
    <>
        ...
        screenOptions={{
          ...
          tabBarBackground: () => (
            <View style={{ flexDirection: "row", justifyContent: "space-evenly", zIndex: 1 }}>
              <Image source={require("../assets/list.png")} style={{ right: 15, top: 8 }} />
              <Image source={require("../assets/talking.png")} style={{ left: 5, top: 8 }} />
      ...
      >
        <Tab.Screen name="병원 정보" component={EditProfile} />
        <Tab.Screen name="증상 공유" component={QuestionList} />
        <Tab.Screen name=" " component={Main} />
        <Tab.Screen name="용품 거래" component={Letter} />
        <Tab.Screen name="마이 프로필" component={MyPage} />
      </Tab.Navigator>
