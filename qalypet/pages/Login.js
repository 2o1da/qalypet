...
const CLIENT_ID_IOS = "940694713872-0ppaebh288o1asrolhhtlkjuqhpjfnb2.apps.googleusercontent.com";
const CLIENT_ID_ANDROID = "940694713872-0ppaebh288o1asrolhhtlkjuqhpjfnb2.apps.googleusercontent.com";
  ...
  return (
    <Container>
      ...
      <View style={{ alignItems: "center", top: -170 }}>
        ...
        <Text style={{ color: "skyblue", fontSize: 50, padding: 30, fontWeight: "bold" }}>QALYPET</Text>
        <Text style={{ color: "rgba(184, 152, 248, 1)", fontSize: 23, padding: 10 }}>간편하게 로그인하고</Text>
        <Text style={{ color: "white", fontSize: 27, fontWeight: "bold" }}>우리 반려동물의 건강을 챙겨보아요!</Text>
      </View>
